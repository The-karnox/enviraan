    ...
    return (
        <LinearGradient colors={['#ffffff', '#f1ffdc']} style={styles.background}>
            <SafeAreaView style={styles.container}>
                ...
                <View style={styles.progressBarContainer}>
                    <Progress value={28} size="xs"    style={styles.progressBar}>
                ...
                <View style={styles.contentContainer}>
                    ...
                    What is the total amount of fuel consumed annually?
                    </UiText>
                       <TextInput
                                            style={styles.input}
      ...
      <SelectPortal>
        ...
        <SelectContent>
          ...
          <SelectItem label="Liters" value="ltr" />
          <SelectItem label="Cubic Meters" value="CM3" />
            <SelectItem label="Gallons" value="gallons" />
        </SelectContent>
      </SelectPortal>
    </Select>
